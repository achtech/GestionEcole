...
<?php require_once('menu.php'); ?>
            <div class="block-header">
                <h2>
                    <?php echo _GESTION ?> <?php echo _UTILISATEURS ?>
                </h2>
                <div> 
                    	<a href="ajouter_users.php" class="ajouter">
                                ...
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
											...
											<td>
												<?php echo $tab_roles[$ligne['role']] ?>
								            </td>
											
											<td class="op">
												<a href="modifier_users.php?users=<?php echo $ligne['id'] ?>" class="modifier2">
													&nbsp;
								                </a>
