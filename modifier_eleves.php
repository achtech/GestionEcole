                            ...
                            onsubmit="return checkForm(document.frm);" >
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        ...
                                        value="<?php echo  getValeurChamp('cin_mere','eleves','id',$_REQUEST['eleves']) ?>">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" id="adresse_parents" name="adresse_parents" class="form-control" value="<?php echo  getValeurChamp('adresse_parents','eleves','id',$_REQUEST['eleves']) ?>">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" id="adresse_personnels" name="adresse_personnels" class="form-control" value="<?php echo  getValeurChamp('adresse_personnels','eleves','id',$_REQUEST['eleves']) ?>">
                                    </div>
                                </div>
